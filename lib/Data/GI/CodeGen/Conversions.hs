...
ocamlDataConv (TBasicType t) =
  case t of
    ...
    TUInt16   -> notImplementedError "This ocamlDataConv (TUInt16) isn't implemented"
    TInt32    -> return "int32"
    ...
    TGType    -> notImplementedError "This ocamlDataConv (TGType) isn't implemented yet"
    TUTF8     -> return "string"
    TFileName -> return "string"
    TPtr      -> notImplementedError "This ocamlDataConv (TPtr) isn't implemented yet"
    TIntPtr   -> notImplementedError "This ocamlDataConv (TIntPtr) isn't implemented yet"
    TUIntPtr  -> notImplementedError "This ocamlDataConv (TUIntPtr) isn't implemented yet"
ocamlDataConv (TError) = notImplementedError "This ocamlDataConv (TError) isn't implemented yet"
ocamlDataConv (TVariant) = notImplementedError "This ocamlDataConv (TVariant) isn't implemented yet"
ocamlDataConv (TParamSpec) = notImplementedError "This ocamlDataConv (TParamSpec) isn't implemented yet"
ocamlDataConv (TCArray _b _i1 _i2 _t) = notImplementedError "This ocamlDataConv (TCArray) isn't implemented yet"
ocamlDataConv (TGArray _t) = notImplementedError "This ocamlDataConv (TGArray) isn't implemented yet"
ocamlDataConv (TPtrArray _t) = notImplementedError "This ocamlDataConv (TPtrArray) isn't implemented yet"
ocamlDataConv (TByteArray) = notImplementedError "This ocamlDataConv (TByteArray) isn't implemented yet"
ocamlDataConv (TGList _t) = notImplementedError "This ocamlDataConv (TGList) isn't implemented yet"
ocamlDataConv (TGSList _t) = notImplementedError "This ocamlDataConv (TGSList) isn't implemented yet"
ocamlDataConv (TGHash _t1 _t2) = notImplementedError "This ocamlDataConv (TGHash) isn't implemented yet"
ocamlDataConv (TGClosure _m) = notImplementedError "This ocamlDataConv (TGClosure) isn't implemented yet"
ocamlDataConv (TInterface n) = do
  let ocamlName = camelCaseToSnakeCase $ name n
  api <- findAPIByName n
  case api of
    APIConst _c     -> notImplementedError "This ocamlDataConv (APIConst) isn't implemented yet"
    APIFunction _f  -> notImplementedError "This ocamlDataConv (APIFunction) isn't implemented yet"
    APICallback _c  -> notImplementedError "This ocamlDataConv (APICallback) isn't implemented yet"
...
ocamlValueToC (TBasicType t) =
  case t of
    ...
    TInt8     -> notImplementedError "This ocamlValueToC (TInt8) isn't implemented yet"
    TUInt8    -> notImplementedError "This ocamlValueToC (TUInt8) isn't implemented yet"
    TInt16    -> notImplementedError "This ocamlValueToC (TInt16) isn't implemented yet"
    TUInt16   -> notImplementedError "This ocamlValueToC (TUInt16) isn't implemented yet"
    TInt32    -> notImplementedError "This ocamlValueToC (TInt32) isn't implemented yet"
    TUInt32   -> notImplementedError "This ocamlValueToC (TUInt32) isn't implemented yet"
    TInt64    -> notImplementedError "This ocamlValueToC (TInt64) isn't implemented yet"
    TUInt64   -> notImplementedError "This ocamlValueToC (TUInt64) isn't implemented yet"
    TFloat    -> return "Float_val"
    TDouble   -> return "Double_val"
    TUniChar  -> return "Char_val"
    TGType    -> notImplementedError "This ocamlValueToC (TGType) isn't implemented yet"
    TUTF8     -> return "String_val"
    TFileName -> return "String_val"
    TPtr      -> notImplementedError "This ocamlValueToC (TPtr) isn't implemented yet"
    TIntPtr   -> notImplementedError "This ocamlValueToC (TIntPtr) isn't implemented yet"
    TUIntPtr  -> notImplementedError "This ocamlValueToC (TUIntPtr) isn't implemented yet"
ocamlValueToC (TError) = notImplementedError "This ocamlValueToC (TError) isn't implemented yet"
ocamlValueToC (TVariant) = notImplementedError "This ocamlValueToC (TVariant) isn't implemented yet"
ocamlValueToC (TParamSpec) = notImplementedError "This ocamlValueToC (TParamSpec) isn't implemented yet"
ocamlValueToC (TCArray _b _i1 _i2 _t) = notImplementedError "This ocamlValueToC (TCArray) isn't implemented yet"
ocamlValueToC (TGArray _t) = notImplementedError "This ocamlValueToC (TGArray) isn't implemented yet"
ocamlValueToC (TPtrArray _t) = notImplementedError "This ocamlValueToC (TPtrArray) isn't implemented yet"
ocamlValueToC (TByteArray) = notImplementedError "This ocamlValueToC (TByteArray) isn't implemented yet"
ocamlValueToC (TGList _t) = notImplementedError "This ocamlValueToC (TGList) isn't implemented yet"
ocamlValueToC (TGSList _t) = notImplementedError "This ocamlValueToC (TGSList) isn't implemented yet"
ocamlValueToC (TGHash _t1 _t2) = notImplementedError "This ocamlValueToC (TGHash) isn't implemented yet"
ocamlValueToC (TGClosure _m) = notImplementedError "This ocamlValueToC (TGClosure) isn't implemented yet"
ocamlValueToC (TInterface n) = do
  api <- findAPIByName n
  case api of
    APIConst _c     -> notImplementedError "This ocamlValueToC (APIConst) isn't implemented yet"
    APIFunction _f  -> notImplementedError "This ocamlValueToC (APIFunction) isn't implemented yet"
...
cToOCamlValue (Just (TBasicType t)) =
  case t of
    ...
    TInt8     -> notImplementedError "This cToOCamlValue (TInt8) isn't implemented yet"
    TUInt8    -> notImplementedError "This cToOCamlValue (TUInt8) isn't implemented yet"
    TInt16    -> notImplementedError "This cToOCamlValue (TInt16) isn't implemented yet"
    TUInt16   -> notImplementedError "This cToOCamlValue (TUInt16) isn't implemented yet"
    ...
    TGType    -> notImplementedError "This cToOCamlValue (TGType) isn't implemented yet"
    TUTF8     -> return "Val_string"
    TFileName -> return "Val_string"
    TPtr      -> notImplementedError "This cToOCamlValue (TPtr) isn't implemented yet"
    TIntPtr   -> notImplementedError "This cToOCamlValue (TIntPtr) isn't implemented yet"
    TUIntPtr  -> notImplementedError "This cToOCamlValue (TUIntPtr) isn't implemented yet"
cToOCamlValue (Just (TError)) = notImplementedError "This cToOCamlValue (TError) isn't implemented yet"
cToOCamlValue (Just (TVariant)) = notImplementedError "This cToOCamlValue (TVariant) isn't implemented yet"
cToOCamlValue (Just (TParamSpec)) = notImplementedError "This cToOCamlValue (TParamSpec) isn't implemented yet"
cToOCamlValue (Just (TCArray _b _i1 _i2 _t)) = notImplementedError "This cToOCamlValue (TCArray) isn't implemented yet"
cToOCamlValue (Just (TGArray _t)) = notImplementedError "This cToOCamlValue (TGArray) isn't implemented yet"
cToOCamlValue (Just (TPtrArray _t)) = notImplementedError "This cToOCamlValue (TPtrArray) isn't implemented yet"
cToOCamlValue (Just (TByteArray)) = notImplementedError "This cToOCamlValue (TByteArray) isn't implemented yet"
cToOCamlValue (Just (TGList _t)) = notImplementedError "This cToOCamlValue (TGList) isn't implemented yet"
cToOCamlValue (Just (TGSList _t)) = notImplementedError "This cToOCamlValue (TGSList) isn't implemented yet"
cToOCamlValue (Just (TGHash _t1 _t2)) = notImplementedError "This cToOCamlValue (TGHash) isn't implemented yet"
cToOCamlValue (Just (TGClosure _m)) = notImplementedError "This cToOCamlValue (TGClosure) isn't implemented yet"
cToOCamlValue (Just (TInterface n)) = do
  api <- findAPIByName n
  case api of
    APIConst _c     -> notImplementedError "This cToOCamlValue (APIConst) isn't implemented yet"
    APIFunction _f  -> notImplementedError "This cToOCamlValue (APIFunction) isn't implemented yet"
    APICallback _c  -> notImplementedError "This cToOCamlValue (APICallback) isn't implemented yet"
    APIEnum _enum   -> notImplementedError "This cToOCamlValue (Enum) isn't implemented yet"
    APIFlags _f     -> notImplementedError "This cToOCamlValue (APIFlags) isn't implemented yet"
    APIInterface _i -> notImplementedError "This cToOCamlValue (APIInterface) isn't implemented yet"
    APIObject _o    -> return $ "Val_" <> namespace n <> name n
    APIStruct _s    -> notImplementedError "This cToOCamlValue (APIStruct) isn't implemented yet"
    APIUnion _u     -> notImplementedError "This cToOCamlValue (APIUnion) isn't implemented yet"